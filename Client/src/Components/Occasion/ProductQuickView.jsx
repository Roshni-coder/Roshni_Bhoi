...
function ProductQuickView({ product, occasion, onClose }) {
    ...
    return (
        <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed top-10 inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm"
            onClick={onClose}
        >
            <motion.div
                ...
                className="relative w-full max-w-5xl mt-14 max-h-[85vh] overflow-hidden bg-white rounded-3xl shadow-2xl"
