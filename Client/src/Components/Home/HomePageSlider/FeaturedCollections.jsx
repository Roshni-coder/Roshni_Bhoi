                        ...
                        <div key={collection.id} className={index > 0 ? 'mt-16 md:mt-28' : ''}>
                            ...
                            <div className="flex flex-col md:flex-row md:items-end justify-between mb-8 md:mb-12 gap-6">
                                <div className="space-y-2 md:space-y-3">
                                    ...
                                    <h2 className="text-3xl md:text-5xl font-serif text-[#0F3D2E] leading-tight">
                                        {collection.title} <span className="text-xl md:text-2xl inline-block">{collection.emoji}</span>
                                    </h2>
