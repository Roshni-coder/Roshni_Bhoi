              ...
              bulkCart.map((item) => (
                <div key={item._id} className="bg-white border border-[#EDE3D2] rounded-3xl p-6 flex flex-col md:flex-row gap-8 relative transition-all hover:shadow-xl hover:shadow-[#322619]/5">
                  ...
                  <div className="flex-1 flex flex-col justify-between py-2">
                    ...
                    {/* SHOW GIFT MESSAGE */}
                    {item.giftMessage && (
                      <div className="mt-4 bg-[#F9F6F0] p-4 rounded-xl border border-[#EDE3D2]">

                        <p className="text-xs text-[#B58D2F] font-bold uppercase">
                          Gift Message
                        </p>

                        <p className="text-sm italic text-[#322619] mt-1">
                          "{item.giftMessage}"
                        </p>
                        ...
                        <div className="flex gap-6 mt-2 text-xs">
                          ...
                          {item.receiverName && (
                            <div>
                              ...
                              <span className="font-bold ml-1">{item.receiverName}</span>
                            </div>
                          )}
