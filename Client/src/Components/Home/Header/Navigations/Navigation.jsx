          ...
          <ul className="flex items-center justify-center lg:justify-start xl:gap-3 gap-2 w-full">
            {userData && userData.name ? (
              <li ref={userMenuRef} className="relative">
                ...
                {userMenuOpen && (
                  <div className="absolute top-full mt-2 z-20 bg-white rounded shadow-lg w-44 text-sm text-black sm:right-0 left-0">
                    <ul className="list-none m-0 p-2">
                      ...
                      >
                        <li className="py-2 px-2 flex gap-2 items-center hover:bg-gray-100 cursor-pointer text-sm">
                          <FaRegUserCircle className="text-[#7d0492]" /> My
                          Account
                        </li>
                      </Link>
                      <Link
                      ...
                      >
                        <li className="py-2 px-2 flex items-center gap-2 hover:bg-gray-100 cursor-pointer text-sm">
                          <FaRegHeart className="text-[#7d0492]" /> Wishlist
                        </li>
                      </Link>
                      <Link to="/orders" onClick={() => setUserMenuOpen(false)}>
                        <li className="py-2 px-2 flex items-center gap-2 hover:bg-gray-100 cursor-pointer text-sm">
                          <BsBox className="text-[#7d0492]" /> Orders
                        </li>
                      </Link>
                      <li
                        onClick={() => {
                      ...
                      >
                        <RiLogoutCircleLine className="text-[#7d0492]" /> Logout
                      </li>
                    </ul>
                  </div>
                )}
              ...
              <li className="sm:ml-2">
                ...
                >
                  <FaRegUserCircle className="text-[20px] sm:text-[24px]" />
                  Login
                </Button>
              </li>
            )}
